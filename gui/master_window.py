...
class Ui_MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        network_daemon = threading.Thread(target=networking.start, daemon=True)
    ...
    def send(self, *args):
        networking.send_message(self.userChat.text())
    ...
    def poll_for_new_messages(self):
        ...
        while True:
            ...
            logging.info('Internal connection by ', addr)
            while True:
                data = conn.recv(4096)
                if not data:
                    break
